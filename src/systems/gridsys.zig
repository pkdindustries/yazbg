...
fn renderStaticBlocks() void {
    ...
    // Query for entities with BlockTag, GridPos, Sprite, and Position components
    // but WITHOUT Flash component (meaning they've completed their flash animation)
